...
hline_race_selector <- "Saudi Arabian Grand Prix"
...
ad_compile_test_mult %>%
  ...
  #            linetype = "dashed") +
  # saudi arabia cut off 
  geom_hline(aes(yintercept = ifelse(!is.na(hclust), 93, NA),
               group = raceName,
               color = "Override cutoff"),
           linetype = "dashed") +
...
- Turkey
  - Had some dry running, but track definitely started wet
...
Point: the exact values can and should be questioned, but there are legitimate reasons why Portugal has the least lap time improvements and Mexico City had the most
...
# scale laps to % session progressxxxxxxxxxxx
